...
| [TooltipChannelHubService.cs](../../GameLib/Script/Project/UI/Core/Tooltip/TooltipChannelHubService.cs) | mixed boundary | n/a until split | mixes runtime query, value access, player ownership, and camera fallback | split service declaration, lifecycle declaration, and player runtime ownership before ServiceGraph eligibility | no |
