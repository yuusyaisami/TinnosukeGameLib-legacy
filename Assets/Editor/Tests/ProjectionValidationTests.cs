...
namespace TinnosukeGameLib.Tests.Editor
{
    ...
    public sealed class ProjectionValidationTests
    {
        ...
        public void Validate_UnknownProjectedCommandExecutorKeepsSourceRepresentativeNode()
        {
            ...
            DiagnosticPayloadEntry[] additionalPayloadEntries = report.Issues[0].AdditionalPayloadEntries.ToArray();
            Assert.That(additionalPayloadEntries, Has.Some.Matches<DiagnosticPayloadEntry>(entry => entry.Key == "SourceIdentity"));
        }
