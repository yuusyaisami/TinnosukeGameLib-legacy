...
namespace TinnosukeGameLib.Editor.KernelBoot
{
    public static class ScopeAuthoringValidationCodes
    {
        ...
        public const string CommandDeclarationInvalid = "UNITY_COMMAND_DECLARATION_INVALID";
        public const string DuplicateCommandDeclaration = "UNITY_COMMAND_DECLARATION_DUPLICATE_ID";
    }
