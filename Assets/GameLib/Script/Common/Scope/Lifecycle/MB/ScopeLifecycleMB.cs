...
namespace Game.Common
{
    ...
    public sealed class ScopeLifecycleMB : MonoBehaviour, IScopeInstaller
    {
        [Header("Spawn")]
        ...
        public void InstallScopeServices(IRuntimeContainerBuilder builder, IScopeNode scope)
        {
            ...
            if (scope is KernelScopeHost runtime)
            {
            ...
            // Register as scope-multi so the local scope host can resolve lifecycle without parent fallback.
