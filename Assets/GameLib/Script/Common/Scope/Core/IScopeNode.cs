...
namespace Game
{
    public interface IScopeNode
    {
        ...
        IScopeIdentityService? Identity { get; }
    ...
    public interface IScopeGraphHost : IScopeNode
    {
        Component HostComponent { get; }
        GameObject HostGameObject { get; }
        Transform HostTransform { get; }
        void EnsureScopeBuilt();
        UniTask WhenBuiltAsync(CancellationToken ct = default);
        void SetExplicitBuildParent(IScopeNode? parent);
    }
