...
namespace Game.TransformSystem
{
    ...
    /// <summary>
    /// Transform の stable ハンドル。外部はこれを保持する、E
    /// index は swap-remove で変わるため、外部に公開しなぁE��E
    /// </summary>
    ...
    /// <summary>
    /// swap 時に dense index を更新する通知用、E
    /// </summary>
    ...
    public interface IBulkTransformManager : Game.IScopeTickHandler
    {
        int Count { get; }
        int MaxCapacity { get; }
