...
namespace Game
{
    ...
    /// Phase0 uses these to move hierarchy utilities out of the legacy scope alias.
    /// </summary>
    public static class ScopeNodeExtensions
    {
        ...
        /// This mirrors the legacy scope-path helper but for IScopeNode and is safe for mixed runtime/base scopes.
        /// </summary>
