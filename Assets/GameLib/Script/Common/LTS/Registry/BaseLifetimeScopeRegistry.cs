...
namespace Game
{
    ...
    {
        void RegisterScope(IScopeNode scope, ILTSIdentityService identity);
    ...
    public sealed class BaseLifetimeScopeRegistry : IBaseLifetimeScopeRegistry
    {
        ...
        public void RegisterScope(IScopeNode scope, ILTSIdentityService identity)
        {
        ...
        bool TryGetIdentity(IScopeNode scope, out ILTSIdentityService identity)
        {
            identity = null;
            if (scope == null)
                return false;
        ...
        static bool Matches(ILTSIdentityService id, CommandTargetIdentityFilter f)
        {
            if (id == null)
                return false;
