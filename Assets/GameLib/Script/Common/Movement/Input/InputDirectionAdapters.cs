...
namespace Game.Movement
{
        ...
        IDisposable
    {
        ...
        static IBaseScalarService? ResolveScalarService(IObjectResolver resolver)
        {
            if (resolver == null)
                return null;
        ...
        static IActionBlockService? ResolveActionBlockService(IObjectResolver resolver)
        {
            if (resolver == null)
                return null;
