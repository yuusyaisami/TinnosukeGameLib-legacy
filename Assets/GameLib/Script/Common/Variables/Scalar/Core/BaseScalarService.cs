...
{
    /// <summary>
    /// ScalarKey 縺斐→縺ｫ繝ｩ繝ｳ繧ｿ繧､繝繧堤ｮ｡逅・＠縲｀od 繝代う繝励Λ繧､繝ｳ繧帝壹§縺ｦ蛟､繧呈桶縺・Scalar 繧ｵ繝ｼ繝薙せ縲・
    /// 繝ｭ繝ｼ繧ｫ繝ｫ縺ｮ縺ｿ(Local*) / 隕ｪ繝輔か繝ｼ繝ｫ繝舌ャ繧ｯ(Global*) 繧呈・遉ｺ逧・↓菴ｿ縺・・縺代ｋ縲・
    /// </summary>
        ...
        IDisposable
    {
        ...
        public void OnAcquire(IScopeNode scope, bool isReset)
        {
            ...
            // Runtime scope 縺ｯ pool 蜀榊茜逕ｨ縺輔ｌ繧句燕謠舌↑縺ｮ縺ｧ縲、cquire 譎ゅ・ reset 縺ｧ縺ｯ
            // 縺ｾ縺・scalar 縺ｮ local runtime 繧貞ｮ悟・縺ｫ遐ｴ譽・☆繧九・
            // 縺薙％縺ｧ蜿､縺・baseline / modifier / subscription 縺梧ｮ九ｋ縺ｨ縲｝rofile 縺ｮ蜀埼←逕ｨ邨先棡縺ｨ
            // 螳滄圀縺ｫ蜿ら・縺輔ｌ繧句､縺碁｣溘＞驕輔≧縺溘ａ縲√＞縺｣縺溘ｓ螳悟・蛻晄悄蛹悶☆繧九・
            ResetForScopeReuse();

            // 縺昴・逶ｴ蠕後↓ profile binding 繧貞・驕ｩ逕ｨ縺吶ｋ縲・
            // 縺薙ｌ縺ｯ縲継rofile 縺悟ｭ伜惠縺励※縺・ｋ縺ｮ縺ｫ watch 縺ｧ縺ｯ 0/null 縺ｫ縺ｪ繧九榊撫鬘後ｒ髦ｲ縺舌◆繧√〒縲・
            // Acquire/Install 縺ｮ鬆・ｺ丞ｷｮ繧・・逕滓・繧ｿ繧､繝溘Φ繧ｰ縺ｮ蟾ｮ縺ｧ baseline 縺梧栢縺題誠縺｡縺ｦ繧ゅ・
            // 譛邨ら噪縺ｫ profile 螳夂ｾｩ縺ｮ蛟､縺悟ｿ・★ local runtime 縺ｫ謌ｻ繧九ｈ縺・↓縺吶ｋ縲・
        ...
        public ScalarKeyRuntime GetOrCreateRuntime(ScalarKey key)
        {
            ...
            {
                cfg = c; // 螳夂ｾｩ縺後≠繧九→縺阪□縺・config 繧呈戟縺､
            }
        ...
        void ReapplyScopeBindingsIfAvailable()
        {
            ...
            // ScopeBindingRegistry 縺ｯ profile 螳夂ｾｩ縺ｮ螳溷､繧・scalar/blackboard 縺ｫ豬√＠霎ｼ繧雋ｬ蜍吶ｒ謖√▽縲・
            // scalar 蛛ｴ縺ｯ reset 縺ｧ runtime 繧呈ｶ医☆縺溘ａ縲〉egistry 繧貞・螳溯｡後＠縺ｪ縺・→
            // ProfileFloatValue 縺ｮ Default Value / UpdateBaseline 縺悟渚譏縺輔ｌ縺ｪ縺・・
