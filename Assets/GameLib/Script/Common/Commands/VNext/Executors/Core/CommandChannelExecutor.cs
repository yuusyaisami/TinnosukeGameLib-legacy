...
namespace Game.Commands.VNext
{
    public sealed class CommandChannelExecutor : ICommandExecutor
    {
            ...
            string tag)
        {
            ...
            // Owner繧呈・遉ｺ謖・ｮ壹＠縺溷ｴ蜷医・縲∝・繧ｳ繝ｳ繝・く繧ｹ繝医∈縺ｮ繝輔か繝ｼ繝ｫ繝舌ャ繧ｯ繧定｡後ｏ縺ｪ縺・・
            // 縺薙ｌ縺ｫ繧医ｊ縲瑚ｪｰ縺ｮ CommandChannel 繧剃ｽｿ縺・°縲阪ｒ譏守｢ｺ蛹悶☆繧九・
            if (preferOwnerHub)
                return null;

            // Current謖・ｮ壽凾縺ｯ蠕捺擂莠呈鋤縺ｧ蜈・さ繝ｳ繝・く繧ｹ繝医↓繧ゅヵ繧ｩ繝ｼ繝ｫ繝舌ャ繧ｯ縲・
        ...
        static bool TryResolveHubWithTag(IRuntimeResolver? resolver, string tag, out ICommandChannelHubService? hub)
        {
            hub = null;
        ...
        static bool TryResolveHub(IRuntimeResolver? resolver, out ICommandChannelHubService? hub)
        {
            hub = null;
            if (resolver == null)
                return false;
