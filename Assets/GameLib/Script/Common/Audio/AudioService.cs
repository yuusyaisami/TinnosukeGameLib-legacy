...
{
    // ================================================================
    // AudioService - 繧ｪ繝ｼ繝・ぅ繧ｪ蜀咲函繧ｵ繝ｼ繝薙せ
    // ================================================================
    //
    // ## 讎りｦ・
    //
    // 繧ｲ繝ｼ繝蜀・・縺吶∋縺ｦ縺ｮ繧ｵ繧ｦ繝ｳ繝牙・逕溘ｒ邂｡逅・☆繧九・
    // 蜈ｬ髢・API 縺ｯ PlaySound 縺ｮ縺ｿ縲４top/FadeOut 繧・PlaySound 邨檎罰縺ｧ螳溽樟縲・
    //
    // ## 讖溯・
    //
    // - 繝舌せ蛻･ AudioSource 繝励・繝ｫ
    // - 繝輔ぉ繝ｼ繝峨う繝ｳ/繧｢繧ｦ繝・
    // - TimeScale 縺ｫ繧医ｋ繝斐ャ繝∝ｽｱ髻ｿ
    // - 繧ｿ繧ｰ縺ｫ繧医ｋ BGM 邂｡逅・
    //
    // ================================================================

    /// <summary>
    /// 繧ｪ繝ｼ繝・ぅ繧ｪ蜀咲函繧ｵ繝ｼ繝薙せ縺ｮ繧､繝ｳ繧ｿ繝ｼ繝輔ぉ繝ｼ繧ｹ縲・
    /// </summary>
    public interface IAudioService
    {
        /// <summary>
        /// 繧ｵ繧ｦ繝ｳ繝峨ｒ蜀咲函縺吶ｋ縲・
        /// cue=null 縺ｮ蝣ｴ蜷医・ request 縺ｧ謖・ｮ壹＠縺溷ｯｾ雎｡繧・Stop/FadeOut 縺吶ｋ縲・
        /// </summary>
        void PlaySound(IAudioCue cue, SoundRequest request = default);
    }

    /// <summary>
    /// 繧ｪ繝ｼ繝・ぅ繧ｪ蜀咲函繧ｵ繝ｼ繝薙せ縺ｮ螳溯｣・・
    /// </summary>
    public sealed class AudioService : IAudioService, IScopeTickHandler, IDisposable, IScopeAcquireHandler, IScopeReleaseHandler
    {
        // ----------------------------------------------------------------
        // 蜀・Κ繧ｯ繝ｩ繧ｹ
        // ----------------------------------------------------------------
        ...
        public void ConfigureBuses(IEnumerable<AudioBusConfig> configs)
        {
            ...
            // 險ｭ螳壽ｼ上ｌ蟇ｾ遲厄ｼ壽悴險ｭ螳壹・繝舌せ縺ｯ繝・ヵ繧ｩ繝ｫ繝医〒逕滓・
        ...
        public void PlaySound(IAudioCue cue, SoundRequest request = default)
        {
            ...
            if (mixer.Config.SingleInstanceByTag && !string.IsNullOrEmpty(tag))
            {
                ...
                if (existing != null)
                {
                    // 蜷御ｸ繧ｯ繝ｪ繝・・縺ｧ restart 遖∵ｭ｢縺ｪ繧画峩譁ｰ縺ｮ縺ｿ
