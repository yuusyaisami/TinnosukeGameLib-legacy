...
namespace Game.Channel
{
    ...
    /// Text チャネルの Hub、E
    /// - tag -> def/player 管琁E
    /// - dynamic text binding 管琁E��Event + poll / poll-only�E�E
    /// - lifecycle は IScopeAcquireHandler / IScopeReleaseHandler に寁E��めE
    /// </summary>
        ...
        IDisposable
    {
        ...
        readonly IScopeIdentityService? _identity;
        ...
        public TextChannelHubService(
            ...
            IScopeIdentityService? identity = null)
        {
        ...
        void RefreshTrackedVarValue(TextDynamicBindingState state, int varId)
        {
            ...
            // まぁEcommand 時スナップショチE��を基底として復允E��る、E
