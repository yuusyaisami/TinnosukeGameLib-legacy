...
namespace Game.Channel
{
    ...
    public sealed class MeshMaterialPropertyCatalog : IMeshMaterialPropertyRegistry
    {
        public static class Ids
        {
            ...
            public const int ContourGradientStrength = 1102;
            public const int ContourGradientRange = 1103;
            public const int ContourGradientFalloff = 1104;

            public const int EdgeAlphaEnabled = 1200;
            public const int EdgeAlphaGain = 1201;
            public const int EdgeAlphaRange = 1202;
            public const int EdgeAlphaSoftness = 1203;
            ...
            public const int BandsIntensity = 1304;

            public const int EdgeFlowEnabled = 1400;
            public const int EdgeFlowColor = 1401;
            public const int EdgeFlowWidth = 1402;
            public const int EdgeFlowSpeed = 1403;
            public const int EdgeFlowIntensity = 1404;
