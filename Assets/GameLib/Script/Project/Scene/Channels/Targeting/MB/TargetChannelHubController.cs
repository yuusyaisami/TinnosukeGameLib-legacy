...
// Game.Targeting
// ================================================================================
// TargetChannelHubController - Inspector 螳夂ｾｩ縺九ｉ Hub 繧呈ｧ狗ｯ峨☆繧九ヶ繝ｪ繝・ず MB・域眠譁ｹ蠑擾ｼ・
// ================================================================================
//
// 繝ｻMB 縺ｯ IFeatureInstaller 縺ｨ縺励※險ｭ螳壹・縺ｿ菫晄戟縺励∝・譛溷喧繝ｭ繧ｸ繝・け縺ｯ Service 蛛ｴ縺ｸ遘ｻ蜍輔・
// 繝ｻBaseLifetimeScope 萓晏ｭ倥・蟒・ｭ｢縺励！nstallFeature 縺ｮ IScopeNode 繧貞髪荳縺ｮ繧ｹ繧ｳ繝ｼ繝怜・蜿｣縺ｫ縺吶ｋ縲・
// 繝ｻ蠢・ｦ√↑繧峨％縺ｮ繧ｳ繝ｳ繝昴・繝阪Φ繝郁・菴薙ｒ ITargetChannelHub 縺ｨ縺励※蛻ｩ逕ｨ蜿ｯ閭ｽ・郁埋縺・ｧ碑ｭｲ縺ｮ縺ｿ・峨・
// ================================================================================
...
{
    /// <summary>
    /// 莉ｻ諢擾ｼ唔nspector 縺ｧ TargetChannel 繧貞ｮ夂ｾｩ縺励∝ｮ溯｡梧凾縺ｫ Hub 繧呈ｧ狗ｯ峨☆繧九ヶ繝ｪ繝・ずMB縲・
    /// 縺薙ｌ閾ｪ菴薙ｒ ITargetChannelHub 縺ｨ縺励※菴ｿ縺医ｋ・亥ｿ・ｦ√↑繧・DI 縺ｧ縺薙・繧ｳ繝ｳ繝昴・繝阪Φ繝医ｒ逋ｻ骭ｲ・峨・
    /// </summary>
    ...
    public sealed class TargetChannelHubController : MonoBehaviour, ITargetChannelHub, IFeatureInstaller
    {
        ...
        [SerializeField] bool autoInitializeOnStart = true; // Start 譎ゅ↓閾ｪ蜍募・譛溷喧縺吶ｋ縺・

        [FoldoutGroup("Setup")]
        [LabelText("Initial Channels")]
        [ListDrawerSettings(ShowFoldout = true, DraggableItems = true, DefaultExpandedState = true)]
        [SerializeField] List<DynamicValue<TargetChannelPreset>> initialChannels = new(); // 蛻晄悄逋ｻ骭ｲ縺吶ｋ繝√Ε繝阪Ν荳隕ｧ
