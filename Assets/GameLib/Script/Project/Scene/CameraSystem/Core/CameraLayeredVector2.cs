...
{
    public sealed class LayeredVector2
    {
        sealed class Layer
        {
        ...
        public readonly struct LayerSnapshot
        {
            ...
            public LayerSnapshot(string tag, Vector2 value, Vector2 target, float duration, Ease ease, bool isAnimating)
            {
                Tag = tag;
                Value = value;
                Target = target;
        ...
        public Vector2 CurrentSum => SumCurrent();
        public Vector2 TargetSum => SumTarget();
        ...
        public void SetLayer(string tag, Vector2 value)
        {
            SetLayer(tag, value, 0f, Ease.Linear);
        }

        public void SetLayer(string tag, Vector2 value, float duration, Ease ease)
        {
