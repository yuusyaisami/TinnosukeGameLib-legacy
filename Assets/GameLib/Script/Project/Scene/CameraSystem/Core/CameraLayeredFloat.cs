...
{
    public sealed class LayeredFloat
    {
        sealed class Layer
        {
        ...
        public readonly struct LayerSnapshot
        {
            ...
            public LayerSnapshot(string tag, float value, float target, float duration, Ease ease, bool isAnimating)
            {
                Tag = tag;
                Value = value;
                Target = target;
        ...
        public float CurrentSum => SumCurrent();
        public float TargetSum => SumTarget();
        ...
        public void SetLayer(string tag, float value)
        {
            SetLayer(tag, value, 0f, Ease.Linear);
        }

        public void SetLayer(string tag, float value, float duration, Ease ease)
        {
