...
{
    /// <summary>
    /// target Transform ごとの director を管琁E��るレジストリ、E
    /// 同一 target に対して 1 つだぁEdirector を持つ、E
    /// </summary>
    ...
    public sealed class TransformAnimationTargetRegistryService : ITransformAnimationTargetRegistry, IScopeReleaseHandler
    {
        ...
        public TransformAnimationTargetRegistryService(IRuntimeResolver resolver)
        {
