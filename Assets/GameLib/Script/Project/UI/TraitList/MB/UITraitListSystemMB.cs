...
namespace Game.UI.TraitList
{
    ...
    public sealed class UITraitListSystemMB : MonoBehaviour, IScopeInstaller, IUITraitListSystemOptions
    {
        ...
        public void InstallScopeServices(IRuntimeContainerBuilder builder, IScopeNode scope)
        {
            ...
            builder.Register<UITraitListLayoutService>(RuntimeLifetime.Singleton)
            ...
            builder.Register<UITraitListVisualizerService>(RuntimeLifetime.Singleton)
            ...
            builder.Register<UITransformListBuilderService<ITraitInstance, UITraitListSlot, UITraitListVisualInstance, UITraitListLayoutProfileSO, UITraitListVisualizerProfileSO>>(RuntimeLifetime.Singleton)
            ...
            builder.Register<UITraitListBuilderService>(RuntimeLifetime.Singleton)
                .As<IUITraitListBuilderService>()
                .As<IScopeAcquireHandler>()
                .As<IScopeReleaseHandler>();

            builder.Register<UITraitListPlayerService>(RuntimeLifetime.Singleton)
                .WithParameter(scope)
