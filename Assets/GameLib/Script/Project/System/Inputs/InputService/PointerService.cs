...
{
    /// <summary>
    /// 迴ｾ蝨ｨ縺ｮ繧ｳ繝ｳ繝医Ο繝ｼ繝ｫ繧ｹ繧ｭ繝ｼ繝縺ｫ蠢懊§縺溘・繧､繝ｳ繧ｿ蠎ｧ讓吶ｒ謠蝉ｾ帙☆繧九し繝ｼ繝薙せ縲・
    /// Gamepad 縺ｮ蝣ｴ蜷医・莉ｮ諠ｳ繧ｫ繝ｼ繧ｽ繝ｫ繧堤ｮ｡逅・☆繧九・
    /// </summary>
    public sealed class PointerService : IPointerService, IScopeTickHandler
    {
