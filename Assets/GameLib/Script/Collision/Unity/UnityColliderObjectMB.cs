...
{
    /// <summary>
    /// Unity標準�ECollider2DめECollisionSystem の self(dynamic) として登録するMB、E
    /// Hit の購読/コマンド�E既存�E HitColliderChannelRuntime を利用する、E
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class UnityColliderObjectMB : MonoBehaviour, IScopeInstaller
    {
        ...
        public void InstallScopeServices(IRuntimeContainerBuilder builder, IScopeNode scope)
        {
            ...
            builder.Register<UnityColliderObjectService>(RuntimeLifetime.Singleton)
                .AsSelf()
